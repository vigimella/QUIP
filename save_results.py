...
def create_file(mode, execution_time, epochs, batch_size, learning_rate, threshold, IMG_DIM, model_train,
...
def save_exp(mode, files_folder, batch_size, epochs, learning_rate, timestamp, IMG_DIM, execution_time, threshold, model_train,
    ...
    create_file(mode, execution_time, epochs, batch_size, learning_rate, threshold, IMG_DIM, model_train, model_test,
